...
class KubusForm extends StatefulWidget {
  const KubusForm({super.key});

  @override
  State<KubusForm> createState() => _KubusFormState();
}
...
class _KubusFormState extends State<KubusForm> {
  ...
  void _hitung() {
    double s = double.tryParse(_controller.text) ?? 0;
    if (s > 0) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          // Header Card dengan desain Detail sesuai permintaan
          _buildHeaderCard(
            assetPath: 'assets/kubus.png',
            title: 'Volume Kubus',
            formula: 'V = s³',
            keterangan: 's = panjang sisi kubus',
            caraKerja: 'Kubus memiliki 6 sisi yang sama panjang. Volume dihitung dengan mengalikan panjang sisi 3 kali (s × s × s).',
          ...
          _buildTextField(_controller, 'Masukkan panjang sisi'),
                ...
                child: Padding(
                  ...
                  child: Image.asset(
                    ...
                    errorBuilder: (context, error, stackTrace) {
                      return const Icon(Icons.view_in_ar, color: Colors.white);
                    },
                  ),
                ),
              ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                const Row(
                  children: [
                    Icon(Icons.straighten, color: Colors.orangeAccent, size: 18),
                    SizedBox(width: 8),
                    Text(
                      'Rumus:', 
                ...
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Icon(Icons.lightbulb, color: Colors.orangeAccent, size: 18),
        ...
        Row(
          ...
          children: [
            ...
            TextButton.icon(
              ...
              label: const Text("Hapus", style: TextStyle(color: Colors.orangeAccent)),
            ),
          ],
        ),
        const SizedBox(height: 10),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.history, color: Colors.orange, size: 18),
                  ),
                  const SizedBox(width: 15),
                  Expanded(
                    child: Column(
